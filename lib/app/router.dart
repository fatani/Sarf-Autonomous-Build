...
import 'package:sarf/features/cards/presentation/cards_screen.dart';
import 'package:sarf/features/cards/presentation/edit_card_screen.dart';
...
enum AppRoute {
  ...
  addCard('/settings/cards/add'),
  editCard('/settings/cards/:id/edit'),
